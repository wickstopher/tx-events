...
-- to limit the possible interleavings of communications.  It uses
-- 'forkEvt' so that 'newNWaySChan' may be an 'Evt' action.
--
-----------------------------------------------------------------------------

module Control.Concurrent.TxEvent.NWaySChan.Ver5 (
  -- * Synchronous n-way channels
    NWaySChan     -- abstract
